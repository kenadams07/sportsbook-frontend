...
export class AlterUsersTableRemoveFields1767092835441 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "county" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "salaryLevel" character varying`);
