...
const Home = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full  mx-auto px-2 py-2 ", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full  h-full rounded-lg overflow-hidden shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Carousel, { className: "w-full h-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselContent, { className: "h-full", children: ["slider1", "slider2", "slider3"].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselItem, { className: "h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-full h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
