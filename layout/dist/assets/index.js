...
import LayoutApp, { S as SIGNUP_FAILURE, M as SIGNUP_SUCCESS, Q as SIGNUP, U as LOGOUT_SUCCESS, V as LOGIN_FAILURE, W as LOGIN_SUCCESS, Y as LOGIN, Z as VERIFY_EMAIL_FAILURE, _ as VERIFY_EMAIL_SUCCESS, $ as VERIFY_EMAIL, a0 as LOGOUT_FAILURE, a1 as notifyPromise$1, a2 as signupSuccess, a3 as signupFailure, a4 as verifyEmailSuccess, a5 as verifyEmailFailure, a6 as LOGOUT, j as jsxRuntimeExports, a7 as Provider_default } from './__federation_expose_LayoutApp.js';
import { r as reactDomExports } from './index4.js';
...
var iterator$1 = function iterator(it) {
...
var toString$1 = function toString2() {
...
function proc(env, iterator$1$1, parentContext, parentEffectId, meta, isRoot, cont) {
  ...
  function next(arg, isErr) {
    try {
      var result;
      if (isErr) {
        result = iterator$1$1.throw(arg);
        clear();
      } else if (shouldCancel(arg)) {
        mainTask.status = CANCELLED;
        next.cancel();
        result = func(iterator$1$1.return) ? iterator$1$1.return(TASK_CANCEL) : {
          done: true,
          value: TASK_CANCEL
        };
      } else if (shouldTerminate(arg)) {
        result = func(iterator$1$1.return) ? iterator$1$1.return() : {
          done: true
        };
      } else {
        result = iterator$1$1.next(arg);
      }
      if (!result.done) {
...
function runSaga(_ref, saga) {
  ...
  var iterator$1$1 = saga.apply(void 0, args);
  var effectId = nextSagaId();
  if (sagaMonitor) {
...
const notifyPromise = (promise, message) => {
  return Vt.promise(
    promise.then((res) => {
...
const signupReducer = (state = INIT_STATE$1, action) => {
  switch (action.type) {
    case SIGNUP:
...
function* signupRequest(action) {
  try {
    const data = yield call(() =>
      notifyPromise$1(() => api.post("/users/signup", action.payload), {
...
function* rootSaga$2() {
  yield all$1([watchVerifyEmailAPI()]);
}
