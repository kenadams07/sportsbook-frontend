const currentImports = {};
      ...
      let moduleMap = {
"./LayoutApp":()=>{
      dynamicLoadingCss(["style.css"], false, './LayoutApp');
      return __federation_import('./__federation_expose_LayoutApp.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__layout__' + exposeItemName;
