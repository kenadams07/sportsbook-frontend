...
function isSlottable(child) {
  return React$o.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER;
}
...
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  function createContext3(rootComponentName, defaultContext) {
    const BaseContext = React$n.createContext(defaultContext);
    const index = defaultContexts.length;
    defaultContexts = [...defaultContexts, defaultContext];
    const Provider = (props) => {
      const { scope, children, ...context } = props;
      const Context = scope?.[scopeName]?.[index] || BaseContext;
      const value = React$n.useMemo(() => context, Object.values(context));
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Context.Provider, { value, children });
    };
    Provider.displayName = rootComponentName + "Provider";
    function useContext2(consumerName, scope) {
      const Context = scope?.[scopeName]?.[index] || BaseContext;
      const context = React$n.useContext(Context);
  ...
  const createScope = () => {
    const scopeContexts = defaultContexts.map((defaultContext) => {
      return React$n.createContext(defaultContext);
    });
...
function composeContextScopes(...scopes) {
  ...
  const createScope = () => {
    ...
    return function useComposedScopes(overrideScopes) {
      ...
      return React$n.useMemo(() => ({ [`__scope${baseScope.scopeName}`]: nextScopes }), [nextScopes]);
    };
  };
...
var Primitive = NODES.reduce((primitive, node) => {
  ...
  const Node = React$k.forwardRef((props, forwardedRef) => {
...
function useCallbackRef$1(callback) {
  const callbackRef = React$j.useRef(callback);
  React$j.useEffect(() => {
    callbackRef.current = callback;
  });
  return React$j.useMemo(() => (...args) => callbackRef.current?.(...args), []);
}
...
var FocusScope = React$f.forwardRef((props, forwardedRef) => {
  const {
    loop = false,
    trapped = false,
  ...
  const [container, setContainer] = React$f.useState(null);
  const onMountAutoFocus = useCallbackRef$1(onMountAutoFocusProp);
  const onUnmountAutoFocus = useCallbackRef$1(onUnmountAutoFocusProp);
  const lastFocusedElementRef = React$f.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContainer(node));
  const focusScope = React$f.useRef({
    paused: false,
    pause() {
      this.paused = true;
    },
  ...
  const handleKeyDown = React$f.useCallback(
    (event) => {
...
var useLayoutEffect2 = globalThis?.document ? React$e.useLayoutEffect : () => {
};

// packages/react/id/src/id.tsx
const React$d = await importShared('react');
var useReactId = React$d[" useId ".trim().toString()] || (() => void 0);
var count = 0;
function useId(deterministicId) {
  const [id, setId] = React$d.useState(useReactId());
  useLayoutEffect2(() => {
...
function useSize(element) {
  const [size, setSize] = React$a.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
var Portal = React$8.forwardRef((props, forwardedRef) => {
...
var useInsertionEffect = React$7[" useInsertionEffect ".trim().toString()] || useLayoutEffect2;
function useControllableState({
  ...
  {
    const isControlledRef = React$7.useRef(prop !== void 0);
    React$7.useEffect(() => {
  ...
  const setValue = React$7.useCallback(
    (nextValue) => {
      if (isControlled) {
...
function useUncontrolledState({
  ...
  const [value, setValue] = React$7.useState(defaultProp);
  const prevValueRef = React$7.useRef(value);
  const onChangeRef = React$7.useRef(onChange);
  useInsertionEffect(() => {
...
var useIsomorphicLayoutEffect = typeof window !== 'undefined' ? React$6.useLayoutEffect : React$6.useEffect;
...
var SideCar$1 = function (_a) {
    ...
    return React$5.createElement(Target, __assign({}, rest));
};
...
var RemoveScroll = React$4.forwardRef(function (props, parentRef) {
    ...
    return (React$4.createElement(React$4.Fragment, null,
        enabled && (React$4.createElement(SideCar, { sideCar: effectCar, removeScrollBar: removeScrollBar, shards: shards, noRelative: noRelative, noIsolation: noIsolation, inert: inert, setCallbacks: setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode: gapMode })),
        forwardProps ? (React$4.cloneElement(React$4.Children.only(children), __assign(__assign({}, containerProps), { ref: containerRef }))) : (React$4.createElement(Container, __assign({}, containerProps, { className: className, ref: containerRef }), children))));
});
...
function RemoveScrollSideCar(props) {
    ...
    return (React$1.createElement(React$1.Fragment, null,
        ...
        removeScrollBar ? React$1.createElement(RemoveScrollBar, { noRelative: props.noRelative, gapMode: props.gapMode }) : null));
}
...
export { Anchor as A, Content as C, DismissableLayer as D, FocusScope as F, Primitive as P, Root2 as R, Slot as S, useLayoutEffect2 as a, createContextScope as b, createLucideIcon as c, createCollection as d, useId as e, composeEventHandlers as f, useDirection as g, useControllableState as h, useCallbackRef$1 as i, createPopperScope as j, Portal as k, hideOthers as l, dispatchDiscreteCustomEvent as m, ReactRemoveScroll as n, useFocusGuards as o, createSlot as p, Arrow as q, composeRefs as r, cn as s, buildExports as t, useComposedRefs as u, ChevronDown as v, clsx as w };
