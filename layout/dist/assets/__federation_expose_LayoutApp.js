...
const {createContext,Component,createElement,useContext,useState,useMemo: useMemo$1,forwardRef} = await importShared('react');
...
const NotFound$1 = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white dark:bg-gray-900", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container flex items-center min-h-screen px-6 py-12 mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl", children: "We can’t find that page" }),
...
const InternalServerError = ({ reset }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white dark:bg-gray-900", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-8 px-4 min-h-screen mx-auto max-w-screen-xl lg:py-16 lg:px-6 flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-screen-sm text-center", children: [
...
const {Suspense,lazy,useMemo} = React;
...
const AppRouter = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(MyErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Loader, {}) }), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
...
await importShared('react');
function LayoutApp() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppRouter, {}) }) });
}

export { Outlet as O, LayoutApp as default, jsxRuntimeExports as j, useNavigate as u };
